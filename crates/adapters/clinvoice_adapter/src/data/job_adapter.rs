	...
	+ Updatable<Error = <Self as JobAdapter>::Error>
{
	...
	fn into_view<E, L, O, P>(job: Job, store: &Store) -> Result<JobView, <Self as JobAdapter>::Error>
	where
		E: EmployeeAdapter,
		L: LocationAdapter,
	...
	fn retrieve(query: &query::Job, store: &Store) -> Result<Vec<Job>, <Self as JobAdapter>::Error>;
