...
/// Reusable arguments used for retrieving information from a Winvoice store.
...
pub struct MatchArgs
{
	...
	/// Winvoice.
	///
	/// Because Winvoice uses YAML files to search for items in `[stores]`, you can save the
